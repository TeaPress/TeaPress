...
<ul class="breadcrumbs">
    ...
    <li class="current"><a href="#">Add page</a></li>
    <li class="right"><a href="#" class="tiny button">Save page</a></li>
</ul>
...
<form enctype="multipart/form-data">
    ...
    <div class="buttonized button-bar">
        <ul class="button-group right">
            ...
            <li><a href="#" class="tiny button">Save page</a></li>
        </ul>
        <ul class="button-group left">
            <li><a href="#" class="tiny button alert">Delete page</a></li>
        </ul>
    </div>
</form>
