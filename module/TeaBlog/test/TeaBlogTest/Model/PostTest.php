...
class PostTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testPostInitialState()
    {
        ...
        $this->assertNull(
            $post->getPostId(),
            '"post_id" should initially be null'
        );
        $this->assertNull(
            $post->getTitle(),
        ...
        $this->assertNull(
            ...
            '"short_description" should initially be null'
        );
        ...
        $this->assertNull(
            $post->getThumb(),
            '"thumb" should initially be null'
        );
    ...
    public function testExchangeArraySetsPropertiesCorrectly()
    {
        ...
        $this->assertSame(
            ...
            $post->getShortDescription(),
            '"short_description" was not set correctly'
        );
        $this->assertSame(
            $data['description'],
            $post->getDescription(),
